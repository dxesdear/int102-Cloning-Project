...
<br>
In this project I must use only HTML and CSS for cloning reference website. Thus, it is impossible to clone reference website as same as it but I can use my knowledge from this course to adapt and create a similar one.


In additionaly my professor provided an server for deploys our project. we use a filezilla for this
